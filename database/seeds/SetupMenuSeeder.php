...
// (110, 0, 5, 'View', 'Institute_n_Degree/index', 'Institutes/Degrees', 'fa fa-level-up', 1, NULL, NULL),
// (111, 110, 5, 'Add', 'Institute_n_Degree/add', 'Institutes/Degrees', 'fa fa-level-up', 1, NULL, NULL),
// (112, 110, 5, 'Delete', 'Institute_n_Degree/delete', 'Institutes/Degrees', 'fa fa-level-up', 1, NULL, NULL),
// (113, 110, 5, 'Edit', 'Institute_n_Degree/edit', 'Institutes/Degrees', 'fa fa-level-up', 1, NULL, NULL),

// (114, 0, 4, 'View', 'payrollBankAdvice/index', 'Bank/Cash Advice', 'fa fa-level-up', 1, NULL, NULL),

// (115, 0, 4, 'View', 'payrollReconciliation/index', 'Reconciliation', 'fa fa-level-up', 1, NULL, NULL),

// (116, 0, 4, 'View', 'ManualFoodAllowUpload/index', 'Manual Food Allow.', 'fa fa-level-up', 1, NULL, NULL),
// (117, 116, 4, 'Add', 'ManualFoodAllowUpload/temp', 'Manual Food Allow.', 'fa fa-level-up', 1, NULL, NULL),

// (118, 0, 2, 'View', 'resign/index', 'Resign', 'fa fa-level-up', 1, NULL, NULL),

// (119, 2, 1, 'Leave', 'employee/leave', 'Employee', 'fa fa-level-up', 1, NULL, NULL),
// (120, 2, 1, 'Status', 'employee/status', 'Employee', 'fa fa-level-up', 1, NULL, NULL),
// (121, 2, 1, 'Permission', 'employee/permission', 'Employee', 'fa fa-level-up', 1, NULL, NULL),
// (122, 2, 1, 'Emp Type', 'employee/empType', 'Employee', 'fa fa-level-up', 1, NULL, NULL),
// (123, 2, 1, 'Company Switch', 'employee/companySwitch', 'Employee', 'fa fa-level-up', 1, NULL, NULL),
// (124, 2, 1, 'Only Branch', 'employee/onlyBranch', 'Employee', 'fa fa-level-up', 1, NULL, NULL),
// (125, 0, 4, 'View', 'journal/index', 'Journal', 'fa fa-level-up', 1, NULL, NULL),
// (126, 0, 4, 'View', 'SalarySheetSummery/index', 'Summery', 'fa fa-level-up', 1, NULL, NULL);
