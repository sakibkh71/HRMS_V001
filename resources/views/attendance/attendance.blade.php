    ...
    <div class="col-md-8 col-md-offset-2">
      <div class="panel">
        <div class="panel-heading">
            ...
            <strong>Employee Attendance</strong><span class="text-success"> ( <i class="fa fa-calendar" ></i> {{$last_update_date}} )</span>
        ...
        <div class="panel-body pn" id="showAttendance">
          <table class="table table-bordered" v-if="attendances !=''">
            ...
            <tbody style="background: #fff!important; font-size: 11px!important">
              <tr v-for="(user,uIndex) in attendances" class="text-center" v-if="user.employee_no != 'AFC-001-0000'">
