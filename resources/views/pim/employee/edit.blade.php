                                ...
                                <div v-for="(basic,index) in basics" v-if="index =='id'">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2 pt50" :class="{'has-error': errors.image}">
                                            ...
                                            <br/>
                                            <div class="form-group">
                                                <label for="passport_no" class="col-md-4 control-label">
                                                    <b>CV Upload</b></label>
                                                <div class="col-md-6">
                                                    <input type="file" name="file_cv_img"></input>
                                                    <input type="hidden" name="file_cv_img_old" :value="basics.file_cv"></input>
                                                    <span v-if="basics.file_cv" style="color: green;">*Have CV.</span>
                                                    <span v-else style="color: red;">*No CV Uploaded.</span>
                                                </div>
                                            </div> 
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group" :class="{'has-error': errors.basic_salary}">
                                            <label class="control-label">Basic/Bank Salary Amount: <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group" :class="{'has-error': errors.payment_procedure}">
                                            <label class="control-label">Pyament Procedure: <span class="text-danger">*</span></label>
                                            
                                            <select name="payment_procedure" v-model="salaries.payment_procedure" class="form-control input-sm">
                                                <option value="1">Bank</option>
                                                <option value="2">Cash</option>
                                                <option value="3">Both</option>
                                            </select>

                                            <span v-if="errors.payment_procedure" class="help-block">@{{errors.payment_procedure[0]}}</span>
                                        </div>
                                    </div>
                                </div>
