...
<div class="page-heading">
    ...
    <div class="media clearfix">
      ...
      <div class="media-body va-m">
        ...
        <p>{{$user->designation->designation_name}} ( Joining Date - <b>{{ date('d M Y', strtotime($joining_date)) }}</b> )</p>
      ...
      <div class="media-right pr30 pl50 pull-right">
        @if(!empty($user->file_cv))
          <a href="{{url('storage/'.$confId.'/'.$user->id.'/'.$user->file_cv)}}" target="__blank" class="btn btn-primary btn-sm">Download CV</a>
        @endif
              ...
              <div class="panel-body pb5">
                ...
                <h4>Degree : {{$education->degree->degree_name}}  
                  @if($education->certificate)
                    ...
                    <a target="_blank" href="{{url('storage/'.$confId.'/'.$education->user_id.'/'.$education->certificate)}}" class="pull-right">View Certificate</a>
                    @else
          ...
          <div id="tab3" class="tab-pane">
            ...
            <h4>Salary Information :</h4>
              <div class="panel-body pb5">
                ...
                <h4><span class="text-muted">Gross Salary Amount : </span> {{$user->gross_salary or '0.00'}}</h4>
                <h4><span class="text-muted">Basic Salary Amount : </span> {{$user->basic_salary or '0.00'}}</h4>
                <h4><span class="text-muted">Salary In Cash Amount : </span> {{$user->salary_in_cache or '0.00'}}</h4>
            ...
            <div class="panel">
              ...
              <div class="panel-body pb5">
                 <table class="table table-striped table-hover" cellspacing="0" width="100%">
                        ...
                        <tbody>
                        <?php $total_salary = ($user->gross_salary - $user->salary_in_cache); $salary=0;?>
                        ...
                        @endforeach
                        <tr>
                          <td colspan="4" class="text-right"><strong>Bank Salary : </strong></td>
                        ...
                        <tr>
                          ...
                          <td class="text-right"><strong>
                            {{$user->salary_in_cache or '00.00'}}
                          </strong></td>
                          <td></td>
                        </tr>
                        <tr>
                          <td colspan="4" class="text-right"><strong>Net Salary : </strong></td>
                          <td class="text-right"><strong>
                        ...
                        <tr>
                            <td colspan="4" class="text-right"><strong>Net Salary in words: </strong></td>
          ...
          <div id="tab4" class="tab-pane">
            <div class="panel">
              ...
              <div class="col-md-2">
                ...
                ?>
                <img src="@if($nominees->nominee_photo){{url('storage/'.$configId.'/'.$user->id.'/'.$nominees->nominee_photo)}}@else{{url('img/placeholder.png')}}@endif" class="img-responsive">
              </div>
              </div>
              @empty
                <h5>No Data Available</h5>  
