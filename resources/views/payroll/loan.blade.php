...
<div class="panel">
    <div class="panel-heading">
        <div class="panel-title">
            <span class="glyphicon glyphicon-tasks"></span>Loan/Advance
            ...
            @if(in_array($chkUrl."/add", session('userMenuShare')))
              <span class="pull-right">
                <a v-on:click="modal_open('#loan_modal'), loan = []" onclick="document.getElementById('loan_modal_form').reset()" class="btn btn-sm btn-dark btn-gradient dark"><span class="glyphicons glyphicon-pencil"></span> &nbsp; Add Loan/Advance</a>
              </span>
            @endif
    ...
    <div class="panel">
        <div class="panel-heading">
            <span class="panel-title" v-if="loan !=''">
                <i class="fa fa-rocket"></i>Edit Loan/Advance
            </span>
            <span class="panel-title" v-else>
                <i class="fa fa-rocket"></i>Add Loan/Advance
            </span>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                  ...
                  <form v-if="loan ==''" id="loan_modal_form" method="post" v-on:submit.prevent="addLoan">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group" :class="{'has-error': errors.loanOrAdvance}">
                            <label class="control-label">Loan Or Advance : <span class="text-danger">*</span></label>
                            <select class="form-control select-sm input-sm" name="loanOrAdvance" v-model="loanOrAdvance">
                                <option value="advance">Advance</option>
                                <option value="loan">Loan</option>
                            </select>
                            <span v-if="errors.loanOrAdvance" class="help-block" v-text="errors.loanOrAdvance[0]"></span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group" :class="{'has-error': errors.loan_aganist}">
                            <label class="control-label">Loan/Advance Aganist: <span class="text-danger">*</span></label>
                      ...
                      <div class="col-md-6">
                        <div class="form-group" :class="{'has-error': errors.loan_start_date}">
                            <label class="control-label">Loan/Advance Start Date: <span class="text-danger">*</span></label>
                    ...
                    <div class="row" v-if="loanOrAdvance=='loan'">
                      <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-group" :class="{'has-error': errors.loan_interest_percent}">
                            <label class="control-label">Loan Interest(%): <span class="text-danger">*</span></label>
                            <input type="text" name="loan_interest_percent" class="form-control input-sm" placeholder="Ex:2.5">
                            <span v-if="errors.loan_interest_percent" class="help-block" v-text="errors.loan_interest_percent[0]"></span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group" :class="{'has-error': errors.loan_amount}">
                            <label class="control-label">Loan/Advance Amount : <span class="text-danger">*</span></label>
