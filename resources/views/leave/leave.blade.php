                                        ...
                                        @foreach($leaves as $info)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    {{$info->firstName." ".$info->lastName." (".$info->empNo.") - ".$info->designationName}}
                                                    </a>
                                                ...
                                                <td>
                                                    <a target="_blank" href="{{url("leaveView/$info->id")}}" class="btn-custom"><button type="button" class="btn btn-info btn-xs">View</button>
                                                    </a>
                                                    @if(in_array($chkUrl."/edit", session('userMenuShare')))
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Leave Application{{$onlyBranch}}</h4>
                </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                ...
                                border-radius: 2px;"
                                >
                                    <!-- SHOW ONLY BRANCH USERS FOR LEAVE -->
                                    ...
                                    @if(in_array("employee/onlyBranch", session('userMenuShare')))
                                        <option v-for="(info,index) in users" 
                                            :value="info.id" v-if="info.branch_id == {{$onlyBranch}}"
