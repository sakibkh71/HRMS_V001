...
class LoanRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            'user_id' => 'required',
            'loanOrAdvance' => 'required',
            // 'loan_type_id' => "required_if:loanOrAdvance, 'loan'",
            // 'loan_interest_percent' => "required_if:loanOrAdvance, 'loan'",
    ...
    // {
    //     return [
    //         'loan_type_id.required_if'     => 'The parent field is required if level have parent.',
    //         'loan_interest_percent.required_if'  => 'Selected salary info can not be null !!',
    //     ];
    // }
