...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'employee_no','employee_type_id','branch_id','designation_id','unit_id','supervisor_id', 'payment_procedure','first_name','status','middle_name','last_name','nick_name','email', 'password','mobile_number','photo', 'file_cv', 'company_ids','created_by','updated_by',
    ...
    public function employeeTypeMapFirst(){
        return $this->hasOne('App\Models\UserEmployeeTypeMap');
    }  
    ...
    public function userIncriment(){
        return $this->hasMany('App\Models\Increment');
    }
