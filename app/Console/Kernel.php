...
use App\Console\Commands\EveryDayHolidayWeekendInsert;
...
class Kernel extends ConsoleKernel
{
    ...
    protected $commands = [
        ...
        EveryDayHolidayWeekendInsert::class
    ];
    ...
    protected function schedule(Schedule $schedule)
    {
        if(\Schema::hasTable('configs'))
        {
            ...
            foreach($databases as $database){
                ...
                $schedule->command('auto:insertHolidayWeekend '.$database->database_name)
                        ->dailyAt('1:25');
                        // ->everyMinute();
            }
        }
