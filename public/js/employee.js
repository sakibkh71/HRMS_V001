...
var employee = new Vue({
    ...
    methods : {
        ...
        calculateTotalSalary(){
            ...
            for(sData in this.empSalaries){
                ...
                if(this.empSalaries[sData].salary_info_type == 'allowance'){
                    ...
                    if(this.empSalaries[sData].salary_amount_type == 'percent'){
                        ...
                        tempAllow = this.calculatePercent(gross_salary,tempAmount);
                        totalSalary = totalSalary - tempAllow;
                        tempGrossDeduct = tempGrossDeduct + tempAllow;
                    }else if(this.empSalaries[sData].salary_amount_type == 'fixed'){
                        tempAllow = tempAmount;
                        totalSalary = totalSalary - tempAllow;
                        tempGrossDeduct = tempGrossDeduct + tempAllow;
            ...
            if(basic_salary < 1){
                this.totalSalaryAmount = salary_in_cache + totalSalary;
            }
            else{
            ...
            this.grossSalaryAmountTemp = gross_salary - tempGrossDeduct; //gross After deduction

            this.grossSalaryAmountInWords = this.convertNumberToWords(this.grossSalaryAmount);

            let tempAmountForCheck = 0;

            if(basic_salary < 1){
                tempAmountForCheck = this.totalSalaryAmount;
            }
            else{
                tempAmountForCheck = this.totalSalaryAmount + salary_in_cache;
            }
            // console.log(tempAmountForCheck);
            if(this.grossSalaryAmountTemp == tempAmountForCheck){
            ...
            // if(this.grossSalaryAmountTemp == (this.totalSalaryAmount + salary_in_cache)){
