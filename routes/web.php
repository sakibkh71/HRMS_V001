...
Route::group(['prefix' => '/employee', 'namespace' => 'Pim'],function (){
    ...
    Route::post('/pdfEmpList','EmployeeController@pdfEmpList');
    Route::post('/xlEmpList','EmployeeController@xlEmpList');
    ...
    Route::get('/companys/{id}','EmployeeController@companys');
    Route::post('/updateCompanys','EmployeeController@updateCompanys');

    Route::post('/manual','EmployeeController@manualEmployeeUpload');
    Route::get('/demo','EmployeeController@downloadDemo');
    Route::get('/downloadCV/{id}/{cv}','EmployeeController@downloadCV');
});
...
/*********...HRMS --Institute and Degrees...***********/
Route::group(['prefix' => '/Institute_n_Degree', 'namespace' => 'Pim'],function (){
    Route::get('/index','InstituteDegreeController@index');
    Route::post('/add','InstituteDegreeController@create');
    Route::get('/edit/{id}/{typee}','InstituteDegreeController@edit');
    Route::post('/edit','InstituteDegreeController@update');
    Route::get('/delete/{id}/{typee}','InstituteDegreeController@delete');
});
...
Route::group(['prefix' => 'payroll', 'namespace' => 'Payroll'],function (){
    ...
    Route::post('/addAll','PayrollController@addAllSalary');
    Route::get('/salaries','ReportController@index');
    Route::post('/salaries','ReportController@salaries');
    Route::get('/paySlipPDF/{id}/{salaryMonth}','ReportController@paySlipPDF');
    Route::get('/getSignEmp','ReportController@getSignEmp');
    Route::post('/saveEmpSign','ReportController@saveEmpSign');
});

/********* ......PayRoll SalarySheet***********/
Route::group(['prefix' => 'payrollReport', 'namespace' => 'Payroll'],function (){
    Route::post('/depSalarySheet','payrollReportController@depSalarySheet');
    Route::post('/depSalarySheetExl','payrollReportController@depSalarySheetExl');
});

/********* ......Payroll Bank Advice *************/

Route::group(['prefix' => 'payrollBankAdvice', 'namespace' => 'Payroll'],function (){
    Route::get('/index','payrollBankAdviceController@index');
    Route::post('/index','payrollBankAdviceController@index');
    Route::post('/advicePdf','payrollBankAdviceController@advicePdf');
    Route::post('/adviceXl','payrollBankAdviceController@adviceXl');
    Route::get('/getCoverLetter','payrollBankAdviceController@getCoverLetter');
    Route::post('/saveCoverLetter','payrollBankAdviceController@saveCoverLetter');
});

/********* .....Payroll Reconciliation ........***************/

Route::group(['prefix' => 'payrollReconciliation', 'namespace' => 'Payroll'],function (){
    Route::get('/index','payrollReconciliationController@index');
    Route::post('/index','payrollReconciliationController@index');
    Route::post('/reportPdf','payrollReconciliationController@reportPdf');
    Route::post('/reportXl','payrollReconciliationController@reportXl');
});

/**** .......Manual Food Allowance Upload.....***************/
Route::group(['prefix' => 'ManualFoodAllowUpload', 'namespace' => 'Payroll'],function (){
    Route::get('/index','ManualFoodAllowUploadController@index');
    Route::post('/index','ManualFoodAllowUploadController@index');
    Route::post('/temp','ManualFoodAllowUploadController@temp');
    Route::get('/processData','ManualFoodAllowUploadController@processData');
    Route::get('/demo','ManualFoodAllowUploadController@downloadDemo');
    // Route::post('/reportPdf','payrollReconciliationController@reportPdf');
    // Route::post('/reportXl','payrollReconciliationController@reportXl');
});
...
Route::group(['prefix' => 'journal', 'namespace' => 'Payroll'],function (){
    Route::get('/index','JournalController@index');
    Route::post('/index','JournalController@index');
    Route::post('/reportPdf','JournalController@reportPdf');
    Route::post('/reportXl','JournalController@reportXl');
    Route::get('/getSignEmp','JournalController@getSignEmp');
    Route::post('/saveEmpSign','JournalController@saveEmpSign');
});

/********* .....Payroll Summery Salary Sheet ........***************/

Route::group(['prefix' => 'SalarySheetSummery', 'namespace' => 'Payroll'],function (){
    Route::get('/index','SalarySheetSummeryController@index');
    Route::post('/index','SalarySheetSummeryController@index');
    Route::post('/reportPdf','SalarySheetSummeryController@reportPdf');
    Route::post('/reportXl','SalarySheetSummeryController@reportXl');
});
...
Route::group(['prefix' => '/resign', 'namespace' => 'Leave'],function (){
    Route::get('/index','ResignController@index');
    Route::post('/add','ResignController@create');
    Route::get('/changeStatus/{id}/{stat}','ResignController@changeStatus');
});
